...
class simulate:
    ...
    def integrate_sde(x0,A,B,t_tot,dt):
        ...
        dx = Axdt + Bx dw using Stratonovic interpretation
...
class analyze:
    ...
    def shorrocks_series(ranks,N,q=10,n_step=1000):
        ...
        for i in range(n_step):
            x2=ranks_q[i]
            s_index[i]=analyze.shorrocks_index(x1,x2,N,q)
